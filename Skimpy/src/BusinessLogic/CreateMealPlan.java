...
public class CreateMealPlan extends HttpServlet{
	...
	public static MealPlanner create(){ 
    	...
    	Food ID1 = connection.getFoodData("fooditems", "1");
		Food ID2 = connection.getFoodData("fooditems", "2");
		Food ID3 = connection.getFoodData("fooditems", "3");
		Food ID4 = connection.getFoodData("fooditems", "4");
		Food ID5 = connection.getFoodData("fooditems", "5");
		Food ID6 = connection.getFoodData("fooditems", "6");
		Food ID7 = connection.getFoodData("fooditems", "7");
		Food ID8 = connection.getFoodData("fooditems", "8");
		Food ID9 = connection.getFoodData("fooditems", "9");
		Food ID10 = connection.getFoodData("fooditems", "10");
		Food ID11 = connection.getFoodData("fooditems","11");
