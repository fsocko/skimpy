								...
								<div class="row">
									...
									<div class="col-sm-8">
										<input name="height" id="height" type="text"
											...
											value="<%=session.getAttribute("height") %>">
										<div id="message"></div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-sm-8">
										<input name="weight" id="weight" type="text"
											class="form-control input-sm"
											value="<%=session.getAttribute("weight") %>">
									</div>
								</div>
                    ...
                    <span id="range">"showValue(<%=session.getAttribute("exerciseNo") %>)"</span> --%>
										<div class="birthday-drop">
											<select name="exercise" class="form-control">
												...
												<option value="5">7-21hrs/week of strenuous
													exercise/work</option>
											</select>
										</div>
									</div>
								</div>
									...
									<div class="col-sm-8">
										<div class="birthday-drop">
											<select name="gender" class="form-control">
												<option value="<%=session.getAttribute("genderChar") %>"
													selected><%=session.getAttribute("genderDisp") %></option>
